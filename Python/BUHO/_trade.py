...
def order_book():
    ...
    logger.info(f"{symbol}, $: {current_price}, OBAr: {block_arriba}, OBAb: {block_abajo}, RSI: {rsi:.2f}")
    return(current_price, symbol, distance_block_arriba, distance_block_abajo, rsi)
