...
def mainloop():
    ...
    while True:
        ...
        if distanceBB >= float(config['DISTANCIA_ENTRE_BB']):
            ...
            if (this_message_type == "Sell" or this_message_type == "Buy") and ((last_message_type != this_message_type) or msg_cnt > 30): #Cantidad de ciclos antes de repetir mensaje 90
                ...
                if this_message_type == "Sell" and config["ACTIVAR_SHORT"] == "SI":
                    ...
                    #send_message(f"Orden creada en SHORT para {symbol}")
        ...
        reporte_diario += 1
        if reporte_diario == 2000: #Cada 2800 ciclos envia el resumen del día
