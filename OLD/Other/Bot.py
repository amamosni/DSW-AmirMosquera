...
if __name__ == "__main__":
    ...
    api_key = os.environ.get('deSlD2iXg7wlFbF9RvafSfmpee7LHiy7wbvWSHWtmpJVkhfHqijORmMiGevxQNA3')     # passkey (saved in bashrc for linux)
    api_secret = os.environ.get('MgK4n1Dhzt1HNL5BvOsxOE8u0EtURUYXSUG5B4RsJ8ghK7jABB7XSJivr3RyDt6t')  # secret (saved in bashrc for linux)
